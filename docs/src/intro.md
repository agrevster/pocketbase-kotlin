...
Pocketbase Kotlin offers support for [Pocketbase 0.16](https://github.com/pocketbase/pocketbase/releases/tag/v0.16.10)
and above.
...
dependencies {
    implementation("io.github.agrevster:pocketbase-kotlin:2.3.0")
}
```              