...
/**
 * Used to filter the list of [Record]s returned by a request. See the
 * [Pocketbase docs](https://pocketbase.io/docs/api-rules-and-filters/)
 * for a guide on how to format a filter request.
 *
