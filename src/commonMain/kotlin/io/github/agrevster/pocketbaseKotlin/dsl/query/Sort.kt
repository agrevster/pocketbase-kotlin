...
/**
 * An idiomatic way to handle Pocketbase sorting. Add + before your
 * [SortFields] object to sort with the records you included on top, or
 * add - if you want those items to come last.
 *
...
public data class SortFields(val fields: String) {
    ...
    /**
     * Add this in front of a [SortFields] object to sort the record fields
     * specified in the field list first.
     */
    public operator fun unaryPlus(): SortFields = SortFields("+${this.removeModifiers().fields}")

    /**
     * Add this in front of a [SortFields] object to sort the record fields
     * specified in the field list last.
     */
