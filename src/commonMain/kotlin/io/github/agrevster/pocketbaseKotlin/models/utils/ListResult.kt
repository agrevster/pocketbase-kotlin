 ...
 * @property totalPages the total amount of pages with [perPage] [items] on
 *    each page
 */
public data class ListResult<T>(
    val page: Int = 1, val perPage: Int = 0, val totalItems: Int = 0, val totalPages: Int = 0, val items: List<T>
) {
